...
| Observer MCP adapter (19 read-only observer tools + 1 operator-only) | CP | `integrations/mcp/observer_handlers.py` | `--list-tools` | `test_v33_mcp_observer` | live stdio needs `pip install mcp`; ChatGPT connect = operator step |
